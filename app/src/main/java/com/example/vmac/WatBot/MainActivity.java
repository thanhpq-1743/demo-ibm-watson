...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textService.setUsernameAndPassword("apikey", "rUDJIrtbBAmTNmLxwVmGKi8XzhV_GoTmtJni0O9Hrc5L");
        textService.setEndPoint("https://gateway-wdc.watsonplatform.net/speech-to-text/api/v1");
        ...
        Thread thread = new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    assistantservice.setUsernameAndPassword("apikey", "rUDJIrtbBAmTNmLxwVmGKi8XzhV_GoTmtJni0O9Hrc5L");
                    ...
                    assistantservice.setEndPoint("https://gateway-wdc.watsonplatform.net/speech-to-text/api");
    ...
    private void recordMessage() {
        ...
        speechService.setUsernameAndPassword("apikey", "rUDJIrtbBAmTNmLxwVmGKi8XzhV_GoTmtJni0O9Hrc5L");
...
//        SplittableInputStream is1 = new SplittableInputStream(audio);
//        SplittableInputStream is2 = is1.split();

        /*BufferedInputStream input = new BufferedInputStream(new RecognizeOptions.Builder()
                .audio(audio)
        ...
        try {
            ...
            int count = audio.read(data);
            while (count!=-1){
                baos.write(data,0,count);
                count = audio.read(data);
            }
            baos.flush();
            ...
            File mypath = new File(directory, "ibm");
            FileOutputStream fos = new FileOutputStream(mypath);
            byte[] data2 = new byte[1024];
            count = is1.read(data2);
            while (count!=-1){
